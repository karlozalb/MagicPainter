...
public class QueuedLinearFloodFiller {
    ...
    public QueuedLinearFloodFiller(Bitmap img) {
        copyImage(img);
    }

    public QueuedLinearFloodFiller(Bitmap img, int targetColor, int newColor) {
        useImage(img);
    ...
    public Bitmap floodFill(int x, int y) {
        ...
        resultBitmap.setPixels(pixels, 0, width, 1, 1, width - 1, height - 1);
